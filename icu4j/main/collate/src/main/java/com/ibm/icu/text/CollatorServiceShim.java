...
final class CollatorServiceShim extends Collator.ServiceShim {
    ...
    private static class CService extends ICULocaleService {
        ...
        /**
         * makeInstance() returns an appropriate Collator for any locale. It falls back to root if
         * there is no specific data.
         *
         * <p>Without this override, the service code would fall back to the default locale which is
         * not desirable for an algorithm with a good Unicode default, like collation.
         */
        @Override
