...
/**
 * A class encapsulating a currency, as defined by ISO 4217. A {@code Currency} object can be
 * created given a {@code Locale} or given an ISO 4217 code. Once created, the {@code Currency}
 ...
 * </ul>
 *
 * The {@code DecimalFormat} class uses these data to display currencies.
 *
 * <p>Note: This class deliberately resembles {@code java.util.Currency} but it has a completely
...
public class Currency extends MeasureUnit {
    ...
    /**
     * Selector for getName() indicating the plural long name for a currency, such as "US dollar"
     * for USD in "1 US dollar", and "US dollars" for USD in "2 US dollars".
     *
     * @stable ICU 4.2
     */
    ...
    public enum CurrencyUsage {
        /**
         * a setting to specify currency usage which determines currency digit and rounding for
         * standard usage, for example: "50.00 NT$"
         *
         * @stable ICU 54
         */
        STANDARD,
        ...
        /**
         * a setting to specify currency usage which determines currency digit and rounding for cash
         * usage, for example: "50 NT$"
         *
         * @stable ICU 54
         */
        CASH
    ...
    /* package */ abstract static class ServiceShim {
    ...
    /**
     * Returns an array of Strings which contain the currency identifiers that are valid for the
     * given locale on the given date. If there are no such identifiers, returns null. Returned
     * identifiers are in preference order.
     *
    ...
    /**
     * Returns an array of Strings which contain the currency identifiers that are valid for the
     * given {@link java.util.Locale} on the given date. If there are no such identifiers, returns
     * null. Returned identifiers are in preference order.
     *
     ...
     * @throws IllegalArgumentException if <code>theISOCode</code> is not a 3-letter alpha code.
     * @stable ICU 2.2
     */
    public static Currency getInstance(String theISOCode) {
        ...
        return (Currency)
                MeasureUnit.internalGetInstance("currency", theISOCode.toUpperCase(Locale.ENGLISH));
    }
    ...
    /**
     * Registers a new currency for the provided locale. The returned object is a key that can be
     * used to unregister this currency object.
     *
     * <p>Because ICU may choose to cache Currency objects internally, this must be called at
     * application startup, prior to any calls to Currency.getInstance to avoid undefined behavior.
     *
    ...
    /**
     * Given a key and a locale, returns an array of values for the key for which data exists. If
     * commonlyUsed is true, these are the values that typically are used with this locale,
     * otherwise these are all values for which data exists. This is a common service API.
     *
     * <p>The only supported key is "currency", other values return an empty array.
     *
     * <p>Currency information is based on the region of the locale. If the locale does not indicate
     * a region, {@link ULocale#addLikelySubtags(ULocale)} is used to infer a region, except for the
     * 'und' locale.
     *
     * <p>If commonlyUsed is true, only the currencies known to be in use as of the current date are
     * returned. When there are more than one, these are returned in preference order (typically,
     * this occurs when a country is transitioning to a new currency, and the newer currency is
     * preferred), see <a href="http://unicode.org/reports/tr35/#Supplemental_Currency_Data">Unicode
     * TR#35 Sec. C1</a>. If commonlyUsed is false, all currencies ever used in any locale are
     ...
     * @return an array of values for the given key and the locale. If there is no data, the array
     *     will be empty.
     * @stable ICU 4.2
     */
     ...
     *
     * <p>Note: If the ISO 4217 numeric code is not assigned for the currency or the currency is
    ...
    /**
     * Convenience and compatibility override of getName that requests the symbol name for the
    ...
    /**
     * Returns the display name for the given currency in the given locale. This is a convenient
     * method for getName(ULocale, int, boolean[]);
     *
     * @param locale locale in which to display currency
     * @param nameStyle selector for which kind of name to return. The nameStyle should be
     *     SYMBOL_NAME, NARROW_SYMBOL_NAME, or LONG_NAME. Otherwise, throw IllegalArgumentException.
     * @param isChoiceFormat isChoiceFormat[0] is always set to false, or isChoiceFormat can be
     *     null; display names are static strings; since ICU 4.4, ChoiceFormat patterns are no
     *     longer supported
    ...
    /**
     * Returns the display name for the given currency in the given locale. For example, the display
     * name for the USD currency object in the en_US locale is "$".
     *
     * @param locale locale in which to display currency
     * @param nameStyle selector for which kind of name to return. The nameStyle should be
     *     SYMBOL_NAME, NARROW_SYMBOL_NAME, or LONG_NAME. Otherwise, throw IllegalArgumentException.
    ...
    /**
     * Returns the display name for the given currency in the given locale. This is a convenience
     * overload of getName(ULocale, int, String, boolean[]);
     *
     * @param locale locale in which to display currency
    ...
    public String getName(
            Locale locale, int nameStyle, String pluralCount, boolean[] isChoiceFormat) {
        return getName(ULocale.forLocale(locale), nameStyle, pluralCount, isChoiceFormat);
    }

    /**
     * Returns the display name for the given currency in the given locale. For example, the
     * SYMBOL_NAME for the USD currency object in the en_US locale is "$". The PLURAL_LONG_NAME for
     * the USD currency object when the currency amount is plural is "US dollars", such as in "3.00
     * US dollars"; while the PLURAL_LONG_NAME for the USD currency object when the currency amount
     * is singular is "US dollar", such as in "1.00 US dollar".
     *
     * @param locale locale in which to display currency
     * @param nameStyle selector for which kind of name to return
     * @param pluralCount plural count string for this locale
     ...
     * @return display string for this currency. If the resource data contains no entry for this
     *     currency, then the ISO 4217 code is returned.
     * @throws IllegalArgumentException if the nameStyle is not SYMBOL_NAME, LONG_NAME, or
     *     PLURAL_LONG_NAME.
     * @stable ICU 4.2
     */
    public String getName(
    ...
    /**
     * Returns the display name for this currency in the default locale. If the resource data for
     * the default locale contains no entry for this currency, then the ISO 4217 code is returned.
     *
     * <p>Note: This method is a convenience equivalent for {@link
     * java.util.Currency#getDisplayName()} and is equivalent to <code>
     * getName(Locale.getDefault(), LONG_NAME, null)</code>.
     *
    ...
    /**
     * Returns the display name for this currency in the given locale. If the resource data for the
     * given locale contains no entry for this currency, then the ISO 4217 code is returned.
     *
     * <p>Note: This method is a convenience equivalent for {@link
     * java.util.Currency#getDisplayName(java.util.Locale)} and is equivalent to <code>
     * getName(locale, LONG_NAME, null)</code>.
     *
     * @param locale locale in which to display currency
    ...
    /**
     * Attempt to parse the given string as a currency, either as a display name in the given
     * locale, or as a 3-letter ISO 4217 code. If multiple display names match, then the longest one
     * is selected. If both a display name and a 3-letter ISO code match, then the display name is
     * preferred, unless it's length is less than 3.
     *
    ...
    private static void setupCurrencyTrieVec(
            ULocale locale, List<TextTrieMap<CurrencyStringInfo>> trieVec) {
    ...
    private static class CurrencyNameResultHandler
        ...
        // length length of the key at the current node; values is the list of all the values mapped
        // to
        ...
        public boolean handlePrefixMatch(int matchLength, Iterator<CurrencyStringInfo> values) {
            if (values.hasNext()) {
                // Since the best match criteria is only based on length of key in trie and since
                // all the
    ...
    /**
     * Returns the number of the number of fraction digits that should be displayed for this
     * currency. This is equivalent to getDefaultFractionDigits(CurrencyUsage.STANDARD);
     *
     * <p>Important: The number of fraction digits for a given currency is NOT guaranteed to be
     * constant across versions of ICU or CLDR. For example, do NOT use this value as a mechanism
     * for deciding the magnitude used to store currency values in a database. You should use this
     * value for display purposes only.
     *
     ...
     * currency. This is equivalent to getRoundingIncrement(CurrencyUsage.STANDARD);
     *
    ...
    /**
     * Constructs a currency object for the given ISO 4217 3-letter code. This constructor assumes
     ...
     *
     * <p>Note: For checking availability of a currency on a specific date, specify the date on both
     * <code>from</code> and <code>to</code>. When both <code>from</code> and <code>to</code> are
     * null, this method checks if the specified currency is available all time.
     *
     * @param code The ISO 4217 3-letter code.
     * @param from The lower bound of the date range, inclusive. When <code>from</code> is null,
     *     check the availability of the currency any date before <code>to</code>
     * @param to The upper bound of the date range, inclusive. When <code>to</code> is null, check
     *     the availability of the currency any date after <code>from</code>
    ...
    public static boolean isAvailable(String code, Date from, Date to) {
        ...
        List<String> allActive =
                info.currencies(CurrencyFilter.onDateRange(from, to).withCurrency(code));
