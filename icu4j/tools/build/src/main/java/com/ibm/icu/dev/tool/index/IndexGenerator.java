...
public class IndexGenerator {
    ...
    private static final String stoplist =
            ",char.res,CurrencyData.res,invuca.res,line.res,line_th.res,pnames.res,res_index.res,sent.res,title.res,ucadata.res,ucase.res,uidna.res,unames.res,unorm.res,uprops.res,word.res,word_ja.res,word_POSIX.res,word_th.res";
    ...
    public static void main(String[] args) {
        ...
        DateFormat copyfmt =
                new SimpleDateFormat("'# Copyright (C) 'yyyy' IBM Inc.  All Rights Reserved.'");
        ...
        try (BufferedWriter bw = Files.newBufferedWriter(outFile.toPath(), StandardCharsets.UTF_8);
            ...
            Date now = new Date();
            pw.println(
                    "# Generated by " + IndexGenerator.class.getName() + " on " + fmt.format(now));
    ...
    private static void usage(String msg) {
        ...
        System.out.println(
                "  inDir is an existing directory whose locale-based resources are to be enumerated");
        System.out.println(
                "  outDir is an existing directory in which the res_index.txt file will be placed");
